...
<x-master title="My Publications">
    <section class="bg-gray-100">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
            {{-- @dd($publications); --}}
            {{-- @if (Auth::id() === $publications->profile_id) --}}
            ...
            @else
                ...
                <div class="bg-white border border-gray-300 p-4 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-bold text-gray-900">{{ $profile->name }}</h4>
                                <p class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($publication->created_at)->diffForHumans() }}</p>
                            </div>
                        </div>
